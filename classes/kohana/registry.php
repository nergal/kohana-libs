 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Kohana_Registry extends ArrayObject
{
    /**
     ...
     *
     * @param Registry $registry An object instance of type \Zend\Registry,
     *   or a subclass.
     * @return void
    ...
    public static function setClassName($registryClassName = 'Registry')
    {
        ...
        /**
         * @see Kohana::auto_load
         */
        if (!class_exists($registryClassName)) {
            Kohana::auto_load($registryClassName);
        }
